...
// Added metadata that should display a title in the tab bar
// Added a description that should be visible when looking at the page source.
export const metadata = {
  title: "All Meals From the Community",
  description: "Browse the delicious mean;s shared by our vibrant community.",
};
