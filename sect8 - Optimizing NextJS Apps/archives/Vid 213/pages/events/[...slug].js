    ...
    <Fragment>
      <Head>
        {/*
          ...
          Here, the title is set to 'Filtered Events'.
        */}
        ...
        {/*
          ...
          In this case, the metadata is a description of the document, dynamically set to display all events for the selected month and year.
        */}
        <meta
          name="description"
