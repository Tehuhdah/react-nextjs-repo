...
// Updated
// Section 8, Vid 219 - Optimizing Images with the 'Image' Component & Feature
...
function EventItem(props) {
  ...
  return (
    <li className={classes.item}>
      {/* Render an 'Image' component with the 'src' prop set to the event's 'image' and the 'alt' prop set
       to the event's 'title'. width and height are also set here.*/}
